...
if(isset($_GET['action']) && $_GET['action'] == 'view'){
  if(isset($_GET['playerID']) && hasPlayerRight($loginUserID, $_GET['playerID'])){
    ...
    if(getPlayerCount() > 0){
      ...
      if(hasPlayerEditRight($loginUserID)) $player_edit_btn = '<a href="#" data-playerid="'.$player['playerID'].'" class="editPlayerOpen">
      ...
      if(hasPlayerDeleteRight($loginUserID)) $player_delete_btn = '<a href="#" data-toggle="modal" data-target="#confirmMessage" data-status="danger" data-text="'.Translation::of('msg.delete_really_entry').'" data-href="'.$_moduleLink.'&action=delete&playerID='.$player['playerID'].'">
