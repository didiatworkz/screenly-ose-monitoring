...
if(isset($_GET['action']) && $_GET['action'] == 'view'){
  if(isset($_GET['playerID'])){
    ...
    if($count > 0){
      ...
      if(hasEditRight($loginUserID)) $player_edit_btn = '<a href="#" data-playerid="'.$player['playerID'].'" class="editPlayerOpen">
      ...
      if(hasDeleteRight($loginUserID)) $player_delete_btn = '<a href="#" data-toggle="modal" data-target="#confirmDelete" data-href="index.php?site=players&action=delete&playerID='.$player['playerID'].'">
      ...
      if(checkAddress($player['address'].'/api/'.$apiVersion.'/assets')){
        ...
        if(hasAddRight($loginUserID)) $newAsset	= '<a href="#" data-toggle="modal" data-target="#newAsset" class="btn btn-success btn-block"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> '.Translation::of('new_asset').'</a>';

        if(hasDeleteRight($loginUserID)) $bulkDelete = '<a href="#" data-toggle="modal" data-target="#confirmDeleteAssets" data-href="index.php?site=players&action=view&playerID=21&action2=deleteAllAssets&playerID='.$player['playerID'].'" class="btn btn-warning btn-block mt-4">
